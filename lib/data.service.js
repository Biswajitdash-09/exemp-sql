...
export async function updateVerificationRecord(verificationId, updateData) {
    // Sanitize data to only include valid Prisma fields
    const validFields = [
        'submittedData', 'comparisonResults', 'overallStatus', 
        'matchScore', 'consentGiven', 'pdfReportUrl', 
        'verificationCompletedAt', 'updatedAt'
    ];
